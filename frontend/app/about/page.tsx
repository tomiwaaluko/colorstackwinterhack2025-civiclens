...
const dataSources = [
  {
    ...
    description:
      "Official voting records from Congress.gov and the Library of Congress.",
  },
  {
    icon: Database,
  ...
  },
  {
    ...
    description:
      "Official press releases, verified social media, and congressional testimony.",
  },
  {
    icon: Users,
    title: "Committee Records",
    description:
      "Committee assignments, hearings, and legislative sponsorship data.",
  },
];
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-primary-foreground/80 leading-relaxed">
              CivicLens is an independent, non-partisan platform dedicated to
              providing evidence-based political information. We believe that an
              informed electorate is essential to a healthy democracy.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-muted-foreground leading-relaxed mb-4">
                In an era of information overload and increasing polarization,
                CivicLens provides a space for citizens to access factual
                political information without spin, ranking, or partisan
                framing.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
                We aggregate public records—voting histories, campaign finance
                data, and official statements—and present them in an accessible,
                searchable format. Our AI technology helps users find relevant
                information quickly while maintaining rigorous citation
                standards.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                CivicLens does not tell you what to think. We give you the
                verified facts so you can form your own conclusions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              CivicLens is built on a foundation of ethical AI practices. These
              principles guide every feature we build and every piece of content
              we present.
            </p>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              CivicLens aggregates data from authoritative public sources. Every
              piece of information on our platform can be traced back to its
              original source.
            </p>
      ...
      <section id="transparency" className="py-16 bg-card">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              We believe in being upfront about what CivicLens can and cannot
              do. Here are the current limitations of our platform:
            </p>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              CivicLens is committed to remaining free and accessible to all
              citizens. We rely on grants, institutional partnerships, and
              individual contributions to sustain our work.
            </p>
            <p className="text-sm text-muted-foreground">
              For partnership inquiries, contact us at{" "}
              <a
                href="mailto:partnerships@civiclens.org"
