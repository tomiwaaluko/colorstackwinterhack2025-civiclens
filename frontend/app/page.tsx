...
const issues = [
  {
    ...
    title: "Healthcare",
    description:
      "Medical coverage, prescription drug costs, and healthcare reform legislation.",
    icon: Heart,
    politicianCount: 534,
    voteCount: 2847,
    color: "bg-red-500/20",
  },
  {
    ...
    description:
      "Environmental protection, clean energy initiatives, and climate policy.",
    icon: Leaf,
    politicianCount: 489,
    voteCount: 1956,
...
const principles = [
  {
    ...
    title: "Evidence Only",
    description:
      "Every piece of data is backed by verifiable sources and official records.",
  },
  {
    icon: Shield,
    title: "No Rankings",
    description:
      "We present facts without ratings, rankings, or endorsements of any kind.",
  },
  {
    icon: Eye,
    title: "Full Transparency",
    description:
      "Our methodology and data sources are publicly available for scrutiny.",
  },
];
...
export default function Home() {
  ...
  const handleSearch = (query: string, zip: string) => {
    router.push(
      `/search?q=${encodeURIComponent(query)}&zip=${encodeURIComponent(zip)}`
    );
  };
      ...
      <section className="py-16 border-y border-border bg-card/50">
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            />
            <StatCard icon={FileText} value="850K+" label="Public Statements" />
            <StatCard
              icon={Building2}
              value="12,500+"
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
            <div>
              ...
              <p className="text-muted-foreground max-w-xl">
                Navigate political data by topic area. See which politicians
                have taken notable votes or made public statements on issues
                that matter to you.
              </p>
            </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-primary-foreground/80 max-w-2xl mx-auto">
              CivicLens is built on a foundation of ethical AI practices,
              ensuring our platform serves democracy, not division.
            </p>
          </div>
        ...
        <div className="container">
          <div className="civic-card p-8 md:p-12 text-center">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto mb-8">
              Get evidence-based answers to your political questions. Every
              response comes with verified citations and data sources.
            </p>
