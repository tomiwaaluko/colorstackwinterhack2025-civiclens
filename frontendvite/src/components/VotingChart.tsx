      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} layout="vertical" margin={{ left: 20 }}>
            ...
            />
            <Bar dataKey="yes" name="Yes" fill="hsl(var(--chart-3))" radius={[0, 4, 4, 0]} />
            <Bar dataKey="no" name="No" fill="hsl(var(--chart-2))" radius={[0, 4, 4, 0]} />
            <Bar dataKey="abstain" name="Abstain" fill="hsl(var(--chart-4))" radius={[0, 4, 4, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
