        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link to="/about#principles" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  AI Principles
                </Link>
              </li>
              <li>
                <Link to="/about#methodology" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Methodology
                </Link>
              </li>
              <li>
                <Link to="/about#transparency" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Transparency Policy
                </Link>
              </li>
            </ul>
