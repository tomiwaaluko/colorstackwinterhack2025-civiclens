...
export default function Ask() {
  ...
  const getConfidenceBadge = (confidence: "high" | "medium" | "low") => {
    const configs = {
      ...
      medium: { color: "bg-amber-100 text-amber-800", icon: AlertCircle, label: "Medium Confidence" },
      low: { color: "bg-red-100 text-red-800", icon: AlertCircle, label: "Low Confidence" },
    };
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl bg-muted/50 border border-border">
              ...
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">
                  CivicLens AI only provides factual, cited information. We do not make
                  predictions, rankings, or recommendations. All responses include source citations.
                </p>
              </div>
            </div>
          </div>
            ...
            {messages.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                  Ask questions about politicians' voting records, donors, or public statements.
                </p>
        ...
        <section className="sticky bottom-0 py-4 bg-background border-t border-border">
          <div className="container max-w-4xl">
            ...
            <p className="text-xs text-muted-foreground text-center mt-3">
              All responses are based on verified data sources. CivicLens AI does not
