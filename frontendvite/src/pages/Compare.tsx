          ...
          <div className="container">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground">
                View voting records, donor data, and public statements side by side.
                All data is verified and cited from official sources.
              </p>
            </div>
          </div>
        </section>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-foreground">{politicianA.name}</h3>
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-foreground">{politicianB.name}</h3>
